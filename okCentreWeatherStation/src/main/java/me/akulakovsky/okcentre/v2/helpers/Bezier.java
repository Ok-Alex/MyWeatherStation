...
//    private DataPoint[] bPoints;
//
//
//    public Bezier(LineGraphSeries<DataPoint> series) {
//        Iterator points = series.getValues(series.getLowestValueX(), series.getHighestValueX());
//
//        int n = points.get;
//        if (n < 3) {
